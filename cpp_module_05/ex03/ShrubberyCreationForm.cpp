...
ShrubberyCreationForm::ShrubberyCreationForm() : Form("anonymous", 145, 137)
{
...
ShrubberyCreationForm::ShrubberyCreationForm(std::string target) : Form("anonymous", 145, 137), target(target)
{
